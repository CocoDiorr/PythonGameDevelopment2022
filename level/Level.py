...
class Level:
    ...
    def create_map(self):
        ...
        Solid(self, (self.visible, self.obstacle,), (400, 400), "pics/red_square.jpg")
        turret = Turret(self, (self.visible, self.obstacle,), (400, 500), pygame.math.Vector2(-1, 0), "pics/red_square.jpg")
