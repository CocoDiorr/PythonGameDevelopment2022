...
class Player(Entity):
    ...
    def __init__(self, level, groups, position):
        super().__init__(level, groups, PLAYER_SPRITE_PATH, PLAYER_ANIMATION_PATH, PLAYER_SIZE, position, PLAYER_ABS_ACCEL, PLAYER_MAX_SPEED, PLAYER_HEALTH, max_health=PLAYER_MAX_HEALTH, energy=PLAYER_ENERGY, max_energy=PLAYER_MAX_ENERGY) # move constants from config to __init__ (to create player with certain health, weapon, etc, in new location)
