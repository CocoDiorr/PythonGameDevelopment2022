...
class Enemy(Entity):
    """ """
    def __init__(self, level, groups, image_path, animations_path, size, position, abs_accel, max_speed, health, attack_radius, notice_radius):
        super().__init__(level, groups, image_path, animations_path, size, position, abs_accel, max_speed, health)
