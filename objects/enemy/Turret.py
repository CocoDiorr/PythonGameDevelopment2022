...
class Turret(Enemy):
    ...
    def __init__(self, level, position):
        super().__init__(level, (level.visible, level.obstacle, level.entity), TURRET_PATH, TURRET_SIZE, TURRET_SOUNDS, position, 0, 0, TURRET_HEALTH, TURRET_ATTACK_RADIUS, TURRET_NOTICE_RADIUS)
